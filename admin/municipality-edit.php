...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_name'])) {
        $valid = 0;
        $error_message .= "Town/Municipality Name can not be empty<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Town/Municipality Name already exists<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Town/Municipality updated successfully.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Edit Town / Municipality</h1>
	</div>
	<div class="content-header-right">
		<a href="municipality.php" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Town / Municipality Name <span>*</span></label>
                    <div class="col-sm-4">
