...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= 'You must select a municipality.<br>';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Shipping cost for Rest of Iloilo is updated successfully.';
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Select Municipality <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a municipality does not exist in the above list, the following "Rest of Iloilo" shipping cost will be applied to it.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Shipping Cost (Rest of Iloilo)</h1>
    </div>
</section>
