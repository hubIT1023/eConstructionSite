...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_country'])) {
        $valid = 0;
        $error_message .= "You must select a Town/City.<br>";
    }
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        if (isset($_POST['cust_country'])) {
                                            if ($_POST['cust_country'] == $row['town_id'] || $_POST['cust_country'] == $row['town_name']) {
                                                $selected = 'selected';
                                            }
                                        } 
                                        ?>
                                        <option value="<?php echo $row['town_id']; ?>" <?php echo $selected; ?>><?php echo $row['town_name']; ?></option>
                                        <?php
                                    }
                                    ?>    
                                    </select>
