...
foreach($result as $row) {
    ...
    $p_brand = $row['p_brand'];
    $p_specs = $row['p_specs'];
    $p_delivery_estimate = $row['p_delivery_estimate'];
    $p_pdf = $row['p_pdf'];
    $p_sku = $row['p_sku'];
}
...
$supplier_row = $statement->fetch(PDO::FETCH_ASSOC);
$supplier_name = $supplier_row ? $supplier_row['supplier_name'] : 'Platform Supplies Co';
$supplier_slug = $supplier_row ? $supplier_row['supplier_slug'] : 'platform-supplies';
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-b2b-specs" style="background: #f9f9f9; padding: 15px; border-radius: 4px; margin-bottom: 20px; border-left: 4px solid #F59E0B; font-size: 13px;">
								<ul class="list-unstyled" style="padding-left: 0; line-height: 1.8; margin-bottom: 0; list-style: none;">
									<li><strong>Supplier:</strong> <a href="store.php?slug=<?php echo $supplier_slug; ?>" style="color: #F59E0B; font-weight: bold;"><i class="fa fa-industry"></i> <?php echo htmlspecialchars($supplier_name); ?></a></li>
									<li><strong>SKU / Part Number:</strong> <?php echo htmlspecialchars($p_sku ?: 'N/A'); ?></li>
									<li><strong>Brand:</strong> <?php echo htmlspecialchars($p_brand); ?></li>
									<li><strong>Minimum Order Quantity (MOQ):</strong> <span class="label label-danger" style="background-color: #d9534f;"><?php echo htmlspecialchars($p_moq); ?> units</span></li>
									<li><strong>Estimated Delivery:</strong> <?php echo htmlspecialchars($p_delivery_estimate); ?></li>
									<?php if($p_pdf): ?>
									<li><strong>Product Data Sheet:</strong> <a href="assets/uploads/<?php echo $p_pdf; ?>" class="btn btn-warning btn-xs" style="background-color: #F59E0B; border-color: #F59E0B; font-weight: bold; margin-left: 5px;" download><i class="fa fa-file-pdf-o"></i> Download PDF Specs</a></li>
									<?php else: ?>
									<li><strong>Product Data Sheet:</strong> <a href="#" class="btn btn-default btn-xs disabled" style="margin-left: 5px;"><i class="fa fa-file-pdf-o"></i> No PDF Available</a></li>
									<?php endif; ?>
								</ul>
							</div>
							<div class="p-review">
							...
							<div class="p-quantity">
								...
								<input type="number" class="input-text qty" step="1" min="<?php echo $p_moq; ?>" name="p_qty" value="<?php echo $p_moq; ?>" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric">
							</div>
							<div class="btn-cart btn-cart1" style="display: flex; gap: 10px; margin-top: 15px;">
                                <input type="submit" value="Add to Cart" name="form_add_to_cart" style="background-color: #1F2937; border-color: #1F2937; color: white; font-weight: bold; padding: 10px 20px; font-size: 14px; cursor: pointer; border-radius: 4px;">
                                <a href="request-quote.php?product_id=<?php echo $_REQUEST['id']; ?>" class="btn btn-warning" style="background-color: #F59E0B; border-color: #F59E0B; color: white; font-weight: bold; padding: 10px 20px; font-size: 14px; border-radius: 4px; display: inline-flex; align-items: center; justify-content: center;"><i class="fa fa-file-text-o"></i> Request Custom Quote</a>
							</div>
                            </form>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Highlights</a></li>
                                <li role="presentation"><a href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="tab">Delivery & Returns</a></li>
							</ul>
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="specs" style="margin-top: -30px;">
									<p>
                                        <?php
                                        if($p_specs == '') {
                                            echo 'No technical specifications available.';
                                        } else {
                                            echo nl2br(htmlspecialchars($p_specs));
                                        }
                                        ?>
									</p>
								</div>
