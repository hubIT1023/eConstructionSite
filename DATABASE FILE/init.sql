-- Converted PostgreSQL Database Dump
SET standard_conforming_strings = on;

DROP TABLE IF EXISTS tbl_color CASCADE;
...
CREATE TABLE tbl_customer (
    ...
    cust_status INTEGER NOT NULL
);

DROP TABLE IF EXISTS tbl_customer_message CASCADE;
...
DROP TABLE IF EXISTS tbl_end_category CASCADE;
...
DROP TABLE IF EXISTS tbl_mid_category CASCADE;
...
CREATE TABLE tbl_product (
    ...
    p_is_featured INTEGER NOT NULL,
    p_is_active INTEGER NOT NULL,
...
DROP TABLE IF EXISTS tbl_product_photo CASCADE;
...
CREATE TABLE tbl_settings (
    ...
    ads_above_welcome_on_off INTEGER NOT NULL,
    ads_above_featured_product_on_off INTEGER NOT NULL,
    ads_above_latest_product_on_off INTEGER NOT NULL,
    ads_above_popular_product_on_off INTEGER NOT NULL,
    ads_above_testimonial_on_off INTEGER NOT NULL,
    ads_category_sidebar_on_off INTEGER NOT NULL
);

DROP TABLE IF EXISTS tbl_shipping_cost CASCADE;
...
DROP TABLE IF EXISTS tbl_shipping_cost_all CASCADE;
CREATE TABLE tbl_shipping_cost_all (
    sca_id SERIAL PRIMARY KEY,
    amount varchar(20) NOT NULL
);

DROP TABLE IF EXISTS tbl_size CASCADE;
CREATE TABLE tbl_size (
    size_id SERIAL PRIMARY KEY,
    size_name varchar(255) NOT NULL
);

DROP TABLE IF EXISTS tbl_slider CASCADE;
...
DROP TABLE IF EXISTS tbl_social CASCADE;
...
DROP TABLE IF EXISTS tbl_subscriber CASCADE;
...
DROP TABLE IF EXISTS tbl_top_category CASCADE;
CREATE TABLE tbl_top_category (
    tcat_id SERIAL PRIMARY KEY,
    tcat_name varchar(255) NOT NULL,
    show_on_menu INTEGER NOT NULL
);
...
DROP TABLE IF EXISTS tbl_video CASCADE;
...
SELECT setval(pg_get_serial_sequence('tbl_color', 'color_id'), COALESCE(max(color_id), 1)) FROM tbl_color;
SELECT setval(pg_get_serial_sequence('tbl_country', 'country_id'), COALESCE(max(country_id), 1)) FROM tbl_country;
SELECT setval(pg_get_serial_sequence('tbl_customer', 'cust_id'), COALESCE(max(cust_id), 1)) FROM tbl_customer;
SELECT setval(pg_get_serial_sequence('tbl_customer_message', 'customer_message_id'), COALESCE(max(customer_message_id), 1)) FROM tbl_customer_message;
SELECT setval(pg_get_serial_sequence('tbl_end_category', 'ecat_id'), COALESCE(max(ecat_id), 1)) FROM tbl_end_category;
SELECT setval(pg_get_serial_sequence('tbl_faq', 'faq_id'), COALESCE(max(faq_id), 1)) FROM tbl_faq;
SELECT setval(pg_get_serial_sequence('tbl_language', 'lang_id'), COALESCE(max(lang_id), 1)) FROM tbl_language;
SELECT setval(pg_get_serial_sequence('tbl_mid_category', 'mcat_id'), COALESCE(max(mcat_id), 1)) FROM tbl_mid_category;
SELECT setval(pg_get_serial_sequence('tbl_order', 'id'), COALESCE(max(id), 1)) FROM tbl_order;
SELECT setval(pg_get_serial_sequence('tbl_page', 'id'), COALESCE(max(id), 1)) FROM tbl_page;
SELECT setval(pg_get_serial_sequence('tbl_payment', 'id'), COALESCE(max(id), 1)) FROM tbl_payment;
SELECT setval(pg_get_serial_sequence('tbl_photo', 'id'), COALESCE(max(id), 1)) FROM tbl_photo;
SELECT setval(pg_get_serial_sequence('tbl_post', 'post_id'), COALESCE(max(post_id), 1)) FROM tbl_post;
SELECT setval(pg_get_serial_sequence('tbl_product', 'p_id'), COALESCE(max(p_id), 1)) FROM tbl_product;
SELECT setval(pg_get_serial_sequence('tbl_product_color', 'id'), COALESCE(max(id), 1)) FROM tbl_product_color;
SELECT setval(pg_get_serial_sequence('tbl_product_photo', 'pp_id'), COALESCE(max(pp_id), 1)) FROM tbl_product_photo;
SELECT setval(pg_get_serial_sequence('tbl_product_size', 'id'), COALESCE(max(id), 1)) FROM tbl_product_size;
SELECT setval(pg_get_serial_sequence('tbl_rating', 'rt_id'), COALESCE(max(rt_id), 1)) FROM tbl_rating;
SELECT setval(pg_get_serial_sequence('tbl_service', 'id'), COALESCE(max(id), 1)) FROM tbl_service;
SELECT setval(pg_get_serial_sequence('tbl_settings', 'id'), COALESCE(max(id), 1)) FROM tbl_settings;
SELECT setval(pg_get_serial_sequence('tbl_shipping_cost', 'shipping_cost_id'), COALESCE(max(shipping_cost_id), 1)) FROM tbl_shipping_cost;
SELECT setval(pg_get_serial_sequence('tbl_shipping_cost_all', 'sca_id'), COALESCE(max(sca_id), 1)) FROM tbl_shipping_cost_all;
SELECT setval(pg_get_serial_sequence('tbl_size', 'size_id'), COALESCE(max(size_id), 1)) FROM tbl_size;
SELECT setval(pg_get_serial_sequence('tbl_slider', 'id'), COALESCE(max(id), 1)) FROM tbl_slider;
SELECT setval(pg_get_serial_sequence('tbl_social', 'social_id'), COALESCE(max(social_id), 1)) FROM tbl_social;
SELECT setval(pg_get_serial_sequence('tbl_subscriber', 'subs_id'), COALESCE(max(subs_id), 1)) FROM tbl_subscriber;
SELECT setval(pg_get_serial_sequence('tbl_top_category', 'tcat_id'), COALESCE(max(tcat_id), 1)) FROM tbl_top_category;
SELECT setval(pg_get_serial_sequence('tbl_user', 'id'), COALESCE(max(id), 1)) FROM tbl_user;
SELECT setval(pg_get_serial_sequence('tbl_video', 'id'), COALESCE(max(id), 1)) FROM tbl_video;-- eConstructionSite SaaS Migration Script
